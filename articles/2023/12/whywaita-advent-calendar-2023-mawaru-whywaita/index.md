...
description: >-
  ...
  2023の21日目の記事として、Unityアプリでwhywaitaのアイコンを回すアプリの実装を紹介しています。
pubDatetime: 2023-12-20T15:00:00.000Z
tags:
  - Unity
  - whywaita
...
このクラスは、毎フレームごとの経過時間に応じたメッシュの変換を行列として表して、`MeshFilter`クラスが持つメッシュの頂点に対して行列を乗算する形で変換を適用しています。
