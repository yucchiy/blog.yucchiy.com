...
description: >-
  2026/07/13週のUnity Weeklyです。Unity Hub 3.19.4/3.19.5、CEDEC 2026でのUnity関連セッション、Unity 6.7のCoreCLR Playerの性能検証、宣言的UIフレームワークvelvet、Unity 6時代のR3運用ルール、lilxyzw/Shader-Coreなどを紹介しています。
